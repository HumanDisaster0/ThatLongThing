...
public class SettlementPanelScript : MonoBehaviour
{
    ...
    public void RefreshTexts()
    {
        ...
        if (GoldManager.Instance != null)
        {
            ...
            //text4.text = $"{GoldManager.Instance.totalGold} ({GoldManager.Instance.rewardGold} 획득 - 세금 {GoldManager.Instance.Tax})";

            if (GuildRoomManager.Instance.day == 4)
            {
                text4.text = $"{GoldManager.Instance.totalGold - GoldManager.Instance.Tax} ({GoldManager.Instance.rewardGold} 획득 - 세금 {GoldManager.Instance.Tax})";
            }
            else
            {
